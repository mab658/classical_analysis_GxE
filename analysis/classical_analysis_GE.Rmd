...
weatherPlot <- ggplot(data=weather,aes(x=ENV,y=y,group=1, color=AGROZONE))+geom_line()+geom_point()+
...
# output the plot to a file
ggsave("weatherPlot.jpeg",height=4.2, width=6.5, units="in", dpi=300)
print(weatherPlot)
```
